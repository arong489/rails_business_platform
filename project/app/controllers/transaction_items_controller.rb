class TransactionItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @transaction_item.save
        format.html { redirect_to transaction_item_url(@transaction_item), notice: "Transaction item was successfully created." }
  ...
  private
    ...
    def transaction_item_params
      params.require(:transaction_item).permit(:transactionOrder_id, :product_id, :number)
    end
end
