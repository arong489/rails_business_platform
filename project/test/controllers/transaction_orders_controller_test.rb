...
class TransactionOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_order" do
    assert_difference("TransactionOrder.count") do
      post transaction_orders_url, params: { transaction_order: { consignee: @transaction_order.consignee, delivery_address: @transaction_order.delivery_address, delivery_phone: @transaction_order.delivery_phone, delivery_postcode: @transaction_order.delivery_postcode, order_status: @transaction_order.order_status, user_id: @transaction_order.user_id } }
    end
  ...
  test "should update transaction_order" do
    patch transaction_order_url(@transaction_order), params: { transaction_order: { consignee: @transaction_order.consignee, delivery_address: @transaction_order.delivery_address, delivery_phone: @transaction_order.delivery_phone, delivery_postcode: @transaction_order.delivery_postcode, order_status: @transaction_order.order_status, user_id: @transaction_order.user_id } }
